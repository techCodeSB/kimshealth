    ...
    return (
        <>
            <section class="section d-lg-block d-none">
                <div class="container">
                    <div class="row justify-content-between" data-aos="fade-right">
                        ...
                        <div class="col-md-2 col-4">
                            <div class="over-all-btn text-end">
                                <a href="#">View All <span><img src="img/slider-right-arrow.svg" class="img-fluid"
                                    alt="" /></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                            <div class="media-card" data-aos="fade-right" data-aos-duration="2200" data-aos-delay="100">
                                <div class="media-img">
                                    <a href="#">
                                        <img src="img/media1.jpg" class="img-fluid w-100" alt="" />
                                    </a>
                                </div>
                                <div class="media-content">
                                    ...
                                    <div class="media-border-bottom">
                                        <div class="d-flex align-items-center justify-content-between mt-3">
                                            <div class="media-name">
                                                <div>
                                                    <img src="img/kims-small-logo.png" class="img-fluid" alt="" />
                                                </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-2">
                                        <div class="media-heart">
                                            <div>
                                                <p><span> <img src="img/heart.png" class="img-fluid" alt="" /></span>8</p>
                                            </div>
                                            <img src="img/chat.png" class="img-fluid" alt="" />
                                        </div>
                                        <div class="media-share">
                                            <p><span> <img src="img/share.png" class="img-fluid" alt="" /></span> Share</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                            <div class="media-card" data-aos="fade-right" data-aos-duration="1800" data-aos-delay="100">
                                <div class="media-img">
                                    <a href="#">
                                        <img src="img/media2.jpg" class="img-fluid w-100" alt="" />
                                    </a>
                                </div>
                                <div class="media-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                            <div class="media-card" data-aos="fade-right" data-aos-duration="1400" data-aos-delay="100">
                                <div class="media-img">
                                    <a href="#">
                                        <img src="img/media3.jpg" class="img-fluid w-100" alt="" />
                                    </a>
                                </div>
                                <div class="media-content">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                            <div class="media-card" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">
                                <div class="media-img">
                                    <a href="#">
                                        <img src="img/media4.jpg" class="img-fluid w-100" alt="" />
                                    </a>
                                </div>
                                <div class="media-content">
