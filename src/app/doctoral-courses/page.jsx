...
const DoctoralCourse = async () => {
    ...
    let allDoctoralCourses = await courseData.getAll(pageContent[2].courseCategory?.id);
    let allPhdCourses = await courseData.getAll(pageContent[3].courseCategory?.id);
